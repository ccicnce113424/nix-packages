...
}:
{
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "d0b5eb33719a29839158bee443bb0d5dcfaff4ea";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "d0b5eb33719a29839158bee443bb0d5dcfaff4ea";
      fetchSubmodules = false;
      sha256 = "sha256-Xs68r8WxpLlibx7b+Go0DQ+tPnUYLkTNDBoDfNv4azA=";
    };
    date = "2025-09-23";
  };
  uosc-danmaku = {
  ...
  uosc-danmaku-git = {
    ...
    version = "a1e563b4a966b6b81e9b8616c35cfde161bc09ab";
    src = fetchFromGitHub {
      owner = "Tony15246";
      repo = "uosc_danmaku";
      rev = "a1e563b4a966b6b81e9b8616c35cfde161bc09ab";
      fetchSubmodules = false;
      sha256 = "sha256-2NcYdAZxDJH1heVieGJBqqSNpj+SY6ltpN3PI1/DdS4=";
    };
    date = "2025-09-24";
  };
