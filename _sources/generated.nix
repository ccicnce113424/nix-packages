...
}:
{
  ...
  piliplus = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.1.4.17";
      fetchSubmodules = false;
      sha256 = "sha256-H8PGiX5mmTH3xXkjSUAF+ITTvysVOgRoiQ73eWrmTgo=";
    };
    "pubspec.lock" = builtins.readFile ./piliplus-1.1.4.17/pubspec.lock;
  };
  pixes = {
    pname = "pixes";
    version = "v1.2.0";
  ...
  splayer-git = {
    pname = "splayer-git";
    version = "a1be1e16b2438251f4f5f2a99f71b145a05310b5";
    src = fetchFromGitHub {
      owner = "imsyy";
      repo = "SPlayer";
      rev = "a1be1e16b2438251f4f5f2a99f71b145a05310b5";
      fetchSubmodules = false;
      sha256 = "sha256-QZek19lMG+wExsYlLChPGMRqc4ISIVrRaG/Eqe8rvcI=";
    };
    date = "2025-11-04";
  };
  uosc-danmaku = {
